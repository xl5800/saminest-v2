...
/**
 * 举报活动页面：独立路由（/activities/:id/report），照抄
 * report-post-page.tsx 的结构——同一个 reports 表、同一套
 * REPORT_DUPLICATE/ACCOUNT_RESTRICTED 错误处理，唯一区别是 targetType
 * 传 "activity" 而不是 "post"、标题文案换成"举报活动"，没有理由为这个
 * 场景另起一套表单逻辑。
 *
    ...
    return (
      <main className="flex justify-center px-4 py-10 pb-20 md:pb-10">
        <div className="w-full max-w-md rounded-lg border border-border bg-white p-6 shadow-sm">
          <h1 className="mb-6 text-xl font-bold text-text">举报活动</h1>
