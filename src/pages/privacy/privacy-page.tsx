 ...
 * <button>（视觉上仍然是同一个"text-primary underline"文字链接样式，
 * 只是不再是真的 <a> 标签——点击要先异步调用
 * get_or_create_own_system_conversation() 拿到会话 id 才知道跳去哪，
 * 不能用静态的 href）。这个页面本身不需要登录就能访问，未登录用户点击
 * 会先跳 /login，见 useContactSupport 的注释。
 *
